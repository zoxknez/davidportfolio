  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative h-full overflow-hidden rounded-2xl glass-card transition-all duration-500 hover:shadow-2xl hover:shadow-white/10 hover:-translate-y-2"
      >
